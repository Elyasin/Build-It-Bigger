...
This is the final project of the Gradle course. Description of the final project is copied below.

This final project contains the optional tasks. The optional task is named *executeTest*.
